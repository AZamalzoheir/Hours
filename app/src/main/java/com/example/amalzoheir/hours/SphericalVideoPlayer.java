...
/**
 * Created by Fatma on 18/05/2018.
 */
...
public class SphericalVideoPlayer extends TextureView {
    ...
    private void prepareVideo(String videoPath) {
        ...
        try {
            ...
            Toast.makeText(getContext(),"Preparing video...",Toast.LENGTH_LONG).show();

            videoPlayerInternal.setOnPreparedListener(
                    new MediaPlayer.OnPreparedListener() {
                        @Override
                        public void onPrepared(MediaPlayer mp) {
                            Toast.makeText(getContext(), "Prepared video",Toast.LENGTH_LONG).show();
                            play();
                        }
                    });
            videoPlayerInternal.setOnBufferingUpdateListener(
                    new MediaPlayer.OnBufferingUpdateListener() {
                        ...
                        public void onBufferingUpdate(MediaPlayer mp, int percent) {
                            Toast.makeText(getContext(), "Buffered video" + percent + "%",Toast.LENGTH_LONG).show();
                        }
                    });
